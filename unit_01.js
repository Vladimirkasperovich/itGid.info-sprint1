...
const a = (document.querySelector(".out-12").innerHTML = 3.1415);
...
const out13 = (document.querySelector(
  ".out-13"
).innerHTML = `<img src="https://itgid.info/img/js20/js20_unit_01.png" alt="js">`);
// Task 14.
...
const out20 = (document.querySelector(".out-20").textContent = "<h2>Hi</h2>");
